...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://img.odivex.com/img/img_1757259312_155545e6ba.jpg'))
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003047918112').split()] #(make sure bot is admin)
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002521835919')) #Verification Channel Id 
...
VERIFY_IMG = environ.get("VERIFY_IMG", "https://adespresso.com/wp-content/uploads/2022/09/how-to-get-verified-on-facebook.jpg")
...
DELETE_TIME = int(environ.get("DELETE_TIME", "1200"))  #  deletion time in seconds (default: 5 minutes). Adjust as per your needs.
